...
You must have Python 3.10 or greater on your system to run this script, including the `antlr4` pip package. Note that depending on your system, the package name may be `antlr4-python3-runtime` instead of `antlr4`.
